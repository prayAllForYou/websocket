...
from common.sqlparse.keywords import KEYWORDS, KEYWORDS_COMMON
from common.sqlparse.compat import StringIO, string_types, with_metaclass, text_type
...
class _Lexer(object):
    ...
    def add_filter(self, filter_, **options):
        from common.sqlparse.filters import Filter
